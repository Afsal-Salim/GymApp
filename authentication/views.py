...
class GoogleSignInView(APIView):
    ...
    def post(self, request):
        ...
        # Existing account with same email but created with email/password
        ...
        if existing:
            ...
            # Same email, already Google: link this google_id and sign in
        ...
        # New user: create Customer (Google-only; password set to unguessable 64-char hex)
