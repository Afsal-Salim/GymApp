...
SECRET_KEY = 'django-insecure-z6c&i66hg&#1=4u%vf+!16sg6$7)s2ylke0a0-0p^s!6u++34!'
...
# --- Auth token lifetimes (override via env) ---
# Examples:
#   export AUTH_ACCESS_TOKEN_MINUTES=15
#   export AUTH_REFRESH_TOKEN_DAYS=7
#   export AUTH_PASSWORD_RESET_MINUTES=60
